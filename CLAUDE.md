...
- [x] v1.24.0 - Agent 详细运行日志 + 实时步骤进度显示
- [x] v1.25.0 - 本地 Agent (agent-app) 详细日志 + 实时步骤进度
- [x] v1.26.0 - 完整 LLM 调用日志 + 细粒度步骤进度
- [x] v1.27.0 - 本地机器人自定义工作目录 + 机器人 ID 显示
- [x] v2.0.0 - Model Router 迁移 + Provider 扩展
- [x] v2.1.0 - Agent Skill 管理工具
- [x] v2.2.0 - 沙箱脚本执行
- [x] v2.3.0 - 多模型工具 + 自我赋能
- [x] v2.4.0 - 完善与测试
- [x] v2.5.0 - Bug 修复 + 体验优化 + Skill 安装修复 + 401 认证修复
